...
class ScrapeServiceTest extends NewStartWebTestCase
{
	...
	public function getInfosZalandoTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/khujo%20THERED%20-%20Veste%20d%27hiver%20-%20marron%20-%20ZALANDO.FR.html');
		$this->assertEquals('khujo THERED - Veste d\'hiver - marron - ZALANDO.FR', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/khujo%20THERED%20-%20Veste%20d\'hiver%20-%20marron%20-%20ZALANDO.FR_files/KH122G02A-710@14(1).jpg', $infos->images[0]->src);
	...
	public function getInfosHarrodsTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/Chloe%CC%81%20Bottle%20and%20Bib%20Set%20%20%20Harrods.html');
		$this->assertEquals('Chloé Bottle and Bib Set | Harrods', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/Chlo%C3%A9%20Bottle%20and%20Bib%20Set%20%20%20Harrods_files/3633043(1)', $infos->images[0]->src);
	...
	public function getInfosRalphlaurenTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/Doudoune%20Ether%20-%20Doudounes%20&%20Gilets%20Vestes%20&%20Manteaux%20-%20Ralph%20Lauren%20France.html');
	...
	public function getInfosBalibarisTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/E-shop%20-%20Chemises%20casual%20-%20Tribeca%20%20%20%20Chambray%20-%20Balibaris.html');
	...
	public function getInfosSaintJamesTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/SAINT%20JAMES%20Pull%20raye%CC%81%20homme%20ROCHEFORT.html');
		$this->assertEquals('SAINT JAMES Pull rayé homme ROCHEFORT', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/SAINT%20JAMES%20Pull%20ray%C3%A9%20homme%20ROCHEFORT_files/pki21100006680.jpg', $infos->images[0]->src);
	...
	public function getInfosLevisTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/511%20Slim%20Fit%20Commuter%20%20%20Indigo%20Rigid%20%20%20Jeans%20%20%20Hommes%20%20%20Levi%27s%20%20%20France.html');
		$this->assertEquals('511 Slim Fit Commuter | Indigo Rigid | Jeans | Hommes | Levi\'s | France', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/511%20Slim%20Fit%20Commuter%20%20%20Indigo%20Rigid%20%20%20Jeans%20%20%20Hommes%20%20%20Levi\'s%20%20%20France_files/191110003-2012-fall-front-pdp.jpg', $infos->images[0]->src);
	...
	public function getInfosAsosTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/Superdry%20|%20Superdry%20-%20Brad%20-%20Veste%20en%20cuir%20chez%20ASOS.html');
		$this->assertEquals('Superdry | Superdry - Brad - Veste en cuir chez ASOS', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/Superdry%20%7C%20Superdry%20-%20Brad%20-%20Veste%20en%20cuir%20chez%20ASOS_fichiers/image1xl.jpg', $infos->images[0]->src);
	...
	public function getInfosAsos2Test()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/ASOS%20|%20ASOS%20-%20Caban%20style%20militaire%20-%20Bleu%20marine%20chez%20ASOS.html');
		$this->assertEquals('ASOS | ASOS - Caban style militaire - Bleu marine chez ASOS', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/ASOS%20%7C%20ASOS%20-%20Caban%20style%20militaire%20-%20Bleu%20marine%20chez%20ASOS_fichiers/image1xl.jpg', $infos->images[0]->src);
	...
	public function getInfosMonshowroomTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/Robe%20imprime%CC%81e%20Aunil%20Noir%202two%20en%20promotion%20sur%20MonShowroom.com.html');
		$this->assertEquals('Robe imprimée Aunil Noir 2two en promotion sur MonShowroom.com', $infos->title);
		$this->assertEquals('http://welovegifts.local:8888/newStart/web/test/Robe%20imprime%CC%81e%20Aunil%20Noir%202two%20en%20promotion%20sur%20MonShowroom.com_fichiers/140932-01-e.jpg', $infos->images[0]->src);
	...
	public function getInfosMangoTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/MANGO%20-%20Accessoires%20-%20Bijoux%20-%20Ras-de-cou%20double%20me%CC%81tallique.html');
	...
	public function getInfosZaraTest()
	{
		...
		$infos = $scrapeService->getInfos('http://welovegifts.local:8888/newStart/web/test/MANTEAU%20COURT%20LAINE%20CAPUCHE%20-%20Manteaux%20-%20FEMME%20|%20ZARA%20France.html');

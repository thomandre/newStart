    ...
    add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist){
        ...
        $.ajax({
            ...
            success: function(jsonData)
            {
                ...
                // Balibaris popup
                $('#lightpopup').lightbox_me({
                    centered: true,
                    onLoad: function() {
                        $('#lightpopup').find('input:first').focus()
                    }
                });
            },
            error: function(XMLHttpRequest, textStatus, errorThrown) {
...
$(document).ready(function(){
    $('#cart_block').hover(function() {
        //$('#cart_block h4').height(30);
        $("#cart_block_inside").show();
    }, function() {
        //$('#cart_block h4').height(24);
        $("#cart_block_inside").hide();
    });

    $('#header_user').hover(function() {
        $('#header_user').height(30);
         $("#header_auth").show();
    }, function() {
        $('#header_user').height(24);
        $("#header_auth").hide();
    });
    ajaxCart.overrideButtonsInThePage();
    ajaxCart.refresh();
